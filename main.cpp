...
int main(int argc, char** argv)
{
	...
	std::vector<char> vs_code = aiv::load_file("C:/Users/rober/source/repos/DirectX12AIV/vertex.bin");
	...
	std::vector<char> ps_code = aiv::load_file("C:/Users/rober/source/repos/DirectX12AIV/pixel.bin");
	...
	actor0->LoadMeshFromGLTF(ctx, descriptor_heap_cbv_srv_uav, "D:/Downloads/DamagedHelmet.glb");
	...
	actor1->LoadMeshFromGLTF(ctx, descriptor_heap_cbv_srv_uav, "D:/Downloads/DamagedHelmet.glb");
